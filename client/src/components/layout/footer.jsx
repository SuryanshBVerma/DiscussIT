...
//   const fontt = "";
  ...
  return (
    <footer className="px-4 divide-y bg-black dark:text-gray-100" style={{fontFamily:'Sans-Serif'}}>
      ...
      <div className="py-4 text-sm text-center dark:text-gray-400">
        <Text color={"white"}>© {getCurrentYear()} DiscussIT. All rights reserved</Text>
      </div>
    </footer>
  );
}
